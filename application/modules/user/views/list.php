...
//        "sScrollXInner": "100%",
        //"bFilter": false,
//        "bInfo": false,
        "sAjaxSource": "<?php echo site_url('user/get_data'); ?>",
        "aoColumns": [  
       ...
       return '<input class="chk" type="checkbox" name="chk[]" value="'+ oObj.aData[0] +'"/>';
        ...
        $('#example').dataTable()
            ...
            .columnFilter({aoColumns:[
                      ...
                      { sSelector: "#username" },
                      { sSelector: "#email" },
                      { type:"select", values : [<?php echo implode($userGroup, ","); ?>], sSelector: "#userGroup" }
                    ]}
            ); 
        }); 
</script>
 ...
 <div class="panel-heading action">
    <span><i class="icon-fixed-width icon-user"></i> User</span>  
    <a href="<?php echo site_url(); ?>user/add"><i class="icon-fixed-width icon-file-alt icon-2x"></i></a>
...
<form name="formcrud" method="post" action="<?php echo site_url(); ?>user/" id="formcrud">
