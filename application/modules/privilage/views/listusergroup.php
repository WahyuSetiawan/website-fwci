...
//        "sScrollXInner": "100%",
        //"bFilter": false,
//        "bInfo": false,
        "sAjaxSource": "<?php echo site_url('privilage/get_data'); ?>",
        "aoColumns": [  
 ...
 <div class="panel-heading action">
    ...
    <a href="javascript: setting();"><i class="icon-fixed-width  icon-wrench icon-2x"></i></a>

  </div>
<div class="panel-body">
<form name="formcrud" method="post" action="<?php echo site_url(); ?>privilage/" id="formcrud">
