...
<html lang="en">
  <head>
    ...
    <!--Datatable-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/datatables/media/css/datatables.css">
    <!--Font-->
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/alertify/css/alertify.bootstrap.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/alertify/css/alertify.default.css">
     
    <script src="<?php echo base_url(); ?>assets/js/jquery.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/ant.js"></script>

    <!-- Validation -->
    <script type="text/javascript" src="<?php echo base_url()?>assets/validation/validation.js"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/datatables/media/js/datatables.js"></script>
    <script src="<?php echo base_url(); ?>assets/datatables/media/js/jquery.dataTables.columnFilter.js" type="text/javascript"></script>
    <!--Alertify-->
  ...
  <body>
      ...
      <div id="main">
       <div id="header" class="row show-grid">
            ...
            <div class="col-md-9">
                <span id="logo"><img src="<?php echo base_url(); ?>assets/img/LOGOQ.png" alt="logo" class="img-rounded"></span>    
       ...
       <div class="row show-grid">
           ...
           <ul class="accordion">
			...
			<li id="modul">
				...
				<a href="#one"><i class="icon-fixed-width icon-briefcase icon-large"></i> CRUD</a>

				<ul class="sub-menu">
					
					<li><a href="<?php echo site_url(); ?>crud"><i class="icon-fixed-width icon-group"></i> Basic</a></li>
				...
				<a href="#one"><i class="icon-fixed-width icon-list-alt icon-large"></i>  Generator CRUD </a>

				<ul class="sub-menu">
					
					<li><a href="<?php echo site_url(); ?>generator"><i class="icon-fixed-width icon-align-left"></i> Basic</a></li>
				...
				<a href="#one"><i class="icon-fixed-width icon-list-alt icon-large"></i>  Map</a>

				<ul class="sub-menu">
					
					<li><a href="<?php echo site_url(); ?>googlemap"><i class="icon-fixed-width icon-align-left"></i> Google Map</a></li>
				...
				<a href="#one"><i class="icon-fixed-width icon-list-alt icon-large"></i>  WYSIWYG Editor </a>

				<ul class="sub-menu">
					
					<li><a href="<?php echo site_url(); ?>tinymce"><i class="icon-fixed-width icon-align-left"></i> Tiny MCE</a></li>
					
					<li><a href="<?php echo site_url(); ?>ckeditor"><i class="icon-fixed-width icon-align-left"></i> CKEditor</a></li>
				...
				<a href="#one"><i class="icon-fixed-width icon-list-alt icon-large"></i>  Slider </a>

				<ul class="sub-menu">
					
					<li><a href="<?php echo site_url(); ?>flexslider"><i class="icon-fixed-width icon-align-left"></i> Flex Slider - Basic</a></li>
					
					<li><a href="<?php echo site_url(); ?>flexslider/thumbnail_controlnav"><i class="icon-fixed-width icon-align-left"></i> Flex Slider - Thumbnail Controlnav</a></li>
                                        
                                        <li><a href="<?php echo site_url(); ?>flexslider/carousel_minmax"><i class="icon-fixed-width icon-align-left"></i> Flex Slider - Carousel Min Max</a></li>
				...
				<a href="#four"><i class="icon-fixed-width icon-bar-chart icon-large"></i> Report Graphs</a>
