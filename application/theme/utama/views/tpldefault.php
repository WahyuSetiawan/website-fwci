...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url(); ?>application/theme/utama/assets/css/style.css" rel="stylesheet">
    <!--Bootstrap-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>application/theme/utama/assets/bootstrap/css/bootstrap2.min.css">
    <!--Datatable-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>application/theme/utama/assets/datatables/media/css/datatables.css">
    <!--Font-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>application/theme/utama/assets/fontawesome/css/font-awesome.min.css">
    <!--[if IE 7]>
      <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome-ie7.min.css">
    <![endif]-->
    <!--Alertify-->
    <link rel="stylesheet" href="<?php echo base_url(); ?>application/theme/utama/assets/alertify/css/alertify.core.css"> 
    <link rel="stylesheet" href="<?php echo base_url(); ?>application/theme/utama/assets/alertify/css/alertify.bootstrap.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>application/theme/utama/assets/alertify/css/alertify.default.css">
     
    <script src="<?php echo base_url(); ?>application/theme/utama/assets/js/jquery.min.js"></script>
    <script src="<?php echo base_url(); ?>application/theme/utama/assets/js/ant.js"></script>

    <!-- Validation -->
    <script type="text/javascript" src="<?php echo base_url()?>application/theme/utama/assets/validation/validation.js"></script>
    <script type="text/javascript" src="<?php echo base_url()?>application/theme/utama/assets/validation/jquery.validate.min.js"></script>
    <!--Bootstrap-->
    <script src="<?php echo base_url(); ?>application/theme/utama/assets/bootstrap/js/bootstrap.min.js"></script>
    <!--Datatable-->
    <script src="<?php echo base_url(); ?>application/theme/utama/assets/datatables/media/js/jquery.dataTables.min.js"></script>
    <script src="<?php echo base_url(); ?>application/theme/utama/assets/datatables/media/js/datatables.js"></script>
    <script src="<?php echo base_url(); ?>application/theme/utama/assets/datatables/media/js/jquery.dataTables.columnFilter.js" type="text/javascript"></script>
    <!--Alertify-->
    <script src="<?php echo base_url(); ?>application/theme/utama/assets/alertify/js/alertify.min.js"></script>
