        ...
        <table id="myTable" class="table table-striped table-hover tablesorter" cellspacing="0"> 
            ...
            <td>
                <?php echo $baris->usergroup;?>
                            ...
                            <td width="65"><a href="<?php echo site_url() ?>user/update/<?php echo $baris->id_user;?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span></a></td>
                            <td width="65"><a href="<?php echo site_url() ?>user/delete/<?php echo $baris->id_user;?>" class="btn btn-danger" onClick='return confirm("Anda yakin ingin menghapus data ini?")'><span class="glyphicon glyphicon-trash"></span></a></td>
                          </tr> 
                          <?php
                          $no++;
                          }
